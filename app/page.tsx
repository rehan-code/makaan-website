  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-1/3 h-full bg-[#00AF08]/5 rounded-bl-full -z-10" />
        <div className="absolute bottom-0 left-0 w-1/4 h-2/3 bg-[#00AF08]/5 rounded-tr-full -z-10" />
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-6 py-4 rounded-xl border-2 border-gray-200 focus:border-[#00AF08] focus:ring-2 focus:ring-[#00AF08]/20 transition-all outline-none"
                      required
                    />
                  </div>
                  <button
                    type="submit"
                    className="w-full bg-[#00AF08] text-white px-8 py-4 rounded-xl hover:bg-[#009507] transition-colors shadow-lg shadow-[#00AF08]/20 hover:shadow-xl hover:shadow-[#00AF08]/30"
                  >
                    Get Notified!
                  </button>
                </form>
